...
from administracion.viewsets import viewsets_tasas, viewsets_empresa, viewsets_pagos, viewsets_prestamos, \
    viewsets_user, viewsets_client, viewsets_proveedores, viewsets_acciones_sistema, viewsets_caja
...
router.register(r'api-caja', viewsets_caja.MovimientoContableViewset)
